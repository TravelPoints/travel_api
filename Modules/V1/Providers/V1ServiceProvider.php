...
class V1ServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishes([
            module_path('V1', 'Config/config.php') => config_path('v1.php'),
        ], 'config');
        $this->mergeConfigFrom(
            module_path('V1', 'Config/config.php'), 'v1'
        );
    }
    ...
    public function registerViews()
    {
        ...
        $sourcePath = module_path('V1', 'Resources/views');
    ...
    public function registerTranslations()
    {
        ...
        if (is_dir($langPath)) {
            ...
            $this->loadTranslationsFrom(module_path('V1', 'Resources/lang'), 'v1');
        }
    }
    ...
    public function registerFactories()
    {
        if (! app()->environment('production') && $this->app->runningInConsole()) {
            app(Factory::class)->load(module_path('V1', 'Database/factories'));
        }
    }
